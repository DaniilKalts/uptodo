...
const About = () => (
  <Container>
    <div className="mx-auto mt-10 max-w-3xl pb-40 min-[475px]:mt-14 min-[475px]:pb-44">
      ...
      <div className="grid-col mb-12 grid grid-cols-1 items-baseline gap-14 min-[575px]:grid-cols-2 min-[850px]:grid-cols-3 min-[850px]:gap-8">
      ...
      <div className="mb-12">
        <h2 className="mb-6 text-2xl font-bold text-white min-[475px]:text-3xl">
          Our Vision:
        </h2>
        <p className="mb-4 text-base font-medium text-white-pale min-[475px]:text-lg">
      ...
      <div>
        ...
        <div className="grid gap-8 sm:grid-cols-2">
          <div className="rounded-2xl bg-black-light p-5 min-[475px]:p-7">
            <h3 className="mb-1 text-xl font-bold text-purple min-[475px]:text-2xl">
              Empower Task Mastery
            </h3>
            <p className="text-base font-medium text-white-pale min-[475px]:text-lg">
