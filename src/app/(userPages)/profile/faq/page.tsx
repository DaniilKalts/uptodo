      ...
      <div className="grid border-t border-gray-200 pt-8 text-left dark:border-gray-700 md:grid-cols-2 md:gap-16">
        <div>
          ...
          <div className="mb-10">
            ...
            <p className="text-sm text-gray-500 dark:text-white-pale min-[475px]:text-base">
              Yes, you can set reminders for your tasks in UpTodo. When creating
              or editing a task, you can specify a due date and time, and UpTodo
              will automatically remind you when the task is due.
            </p>
          </div>
          <div className="mb-10">
            <h3 className="mb-4 flex items-center text-lg font-bold text-gray-900 dark:text-white min-[475px]:text-2xl">
