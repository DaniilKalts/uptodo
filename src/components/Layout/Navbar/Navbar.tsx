...
const Navbar = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 z-50 w-full h-20 min-[475px]:h-24 bg-[#363636]">
      <div className="grid h-full max-w-lg grid-cols-5 mx-auto font-medium">
        ...
        >
          ...
          <span className="text-sm min-[475px]:text-base text-[#ffffffdd]">
            Index
          </span>
        </button>
        <button
        ...
        <div className="flex items-center justify-center">
          <button
            ...
            type="button"
            className="inline-flex items-center relative bottom-10 min-[475px]:bottom-12 justify-center w-16 h-16 min-[475px]:w-[4.5rem] min-[475px]:h-[4.5rem] font-medium bg-[#8875FF] rounded-full hover:bg-[#7969e1] group"
          >
            <svg
